...
// Estilos en app/globals.css (.target-cursor-*). En App Router movemos el CSS
// global ahí en vez de importar un .css desde el componente.
...
const TargetCursor = ({
  ...
  // Guard de montaje: evita render en SSR (sin mismatch de hidratación).
