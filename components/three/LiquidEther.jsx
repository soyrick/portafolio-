...
// CREDIT
// LiquidEther — fluid simulation background from React Bits (https://reactbits.dev)
// JavaScript + CSS variant. Renders a WebGL Navier-Stokes-style fluid that reacts
// to the cursor and idles with an auto demo when there is no interaction.
